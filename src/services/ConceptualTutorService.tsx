...
import axiosClient, { axiosConceptualVivaClient } from "../core/api/AxiosClient";
...
export const ConceptualVivaService = {
    ...
    startConceptualViva: async (payload: any) => {
        try{
            const response = await axiosConceptualVivaClient.post(API_ENDPOINT.CONCEPTUAL_VIVA.START_CONCEPTUAL_VIVA, payload);
    ...
    submitConceptualAnswer: async (payload: any) => {
        ...
        try{
            const response = await axiosConceptualVivaClient.post(API_ENDPOINT.CONCEPTUAL_VIVA.SUBMIT_CONCEPTUAL_ANSWER, payload);
    ...
    endConceptualViva: async (payload: { session_id: string | number } ) => {
        ...
        try{
            const response = await axiosConceptualVivaClient.post(API_ENDPOINT.CONCEPTUAL_VIVA.END_CONCEPTUAL_VIVA, payload, {
                headers: {
    ...
    getConceptualVivaResult : async (sessionId: string | number, userId: string | number | undefined) => {
        try{
            const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.GET_CONCEPTUAL_VIVA_RESULT(sessionId, userId));
    ...
    getConceptualVivaHistory: async (userId: string | number | undefined) => {
        try{
            const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.GET_CONCEPTUAL_VIVA_HISTORY(userId));
    ...
    getConceptualVivaSolution: async (userId: string | number | undefined) => {
        try{
            const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.GET_CONCEPTUAL_VIVA_SOLUTION(userId));
    ...
    startConceptualVivaSession: async (payload: any) => {
        ...
        try{
            const response = await axiosConceptualVivaClient.post(API_ENDPOINT.CONCEPTUAL_VIVA.START_CONCEPTUAL_VIVA_SESSION, payload);
    ...
    /*Dashboard Services*/
        ...
        getConceptualDashboardCards: async (userId: string | number, subscriptionId: string | number) => {
            try{
                const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.CONCEPTUAL_DASHBOARD_CARDS(userId, subscriptionId));
        ...
        getConceptualDashboardWeakChapters: async (userId: string | number, subscriptionId: string | number) => {
            try{
                const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.CONCEPTUAL_DASHBOARD_WEAK_CHAPTERS(userId, subscriptionId));
        ...
        getConceptualDashboardWeakTopics: async (userId: string | number, subscriptionId: string | number) => {
            try{
                const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.CONCEPTUAL_DASHBOARD_WEAK_TOPICS(userId, subscriptionId));
        ...
        getConceptualDashboardSubjectRadar: async (userId: string | number, subscriptionId: string | number) => {
            try{
                const response = await axiosConceptualVivaClient.get(API_ENDPOINT.CONCEPTUAL_VIVA.CONCEPTUAL_DASHBOARD_SUBJECT_RADAR(userId, subscriptionId));
